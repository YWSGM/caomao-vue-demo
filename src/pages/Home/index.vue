    ...
    <div class="firstView">
      <div class="content">
        ...
        <div class="list-grow">
          <ul class="grow">
            <li>
              <img class="grow-images" src="./images/1.png" alt />
              <span>网易自营品牌</span>
            </li>
            <li>
              <img class="grow-images" src="./images/2.png" alt />
              <span>30天无忧退货</span>
            </li>
            <li>
              <img class="grow-images" src="./images/3.png" alt />
              <span>48小时快速退款</span>
            </li>
          </ul>
        </div>
        <div class="swiper-slide1">
          <ul class="slide-top">
            <li class="top-item" v-for="(homelist,index) in homelists" :key="index" @click="goto('/toplist')">
        ...
        <div class="bgImage">
          <img src="./images/big-img.gif" alt />
        </div>
